...
PUBLIC void outCharWithColor(CONSOLE* con, char ch, int color) {
	u8* pch = (u8*)(V_MEM_BASE + con->cursor * 2);
	...
	default:
		*pch++ = ch;
		switch (color) {
			case 0: *pch++ = B_WHITE_CHAR; break;
			case 1: *pch++ = B_BLUC_CHAR; break;
			case 2: *pch++ = B_GREEN_CHAR; break;
			case 3: *pch++ = B_CYAN_CHAR; break;
			case 4: *pch++ = B_RED_CHAR; break;
			case 5: *pch++ = B_MAGENTA_CHAR; break;
			case 6: *pch++ = B_BROWN_CHAR; break;
			default: break;
		}
		con->cursor++;
		break;
